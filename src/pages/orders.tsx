...
// import {  Truck, CheckCircle, X, MapPin, FileText, Clock, CreditCard, ChevronRight } from 'lucide-react'
...
//             <p className="font-medium text-gray-800">{userData.shippingInfo[0].address}</p>
//             <p>{userData.shippingInfo[0].city}, {userData.shippingInfo[0].state} {userData.shippingInfo[0].postalCode}</p>
//             <p>{userData.shippingInfo[0].country}</p>
//           </CardContent>
//         </Card>
//       )}
...
import { Separator } from "@/components/ui/separator"
import { Truck, CheckCircle, Clock,MapPin, ChevronRight } from 'lucide-react'
import { useAuth } from '../context/AuthContext'
import React from 'react'
import SkeletonLoader from '@/components/SkeletonLoader'
...
export default function UserOrdersPage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case "Processing":
        return <Badge className="font-normal text-sm bg-blue-500 text-white">Processing</Badge>
      case 'Shipped':
        return <Badge className="font-normal text-sm bg-yellow-500 text-white">Shipped</Badge>
      case 'Delivered':
        return <Badge className="font-normal text-sm bg-green-500 text-white">Delivered</Badge>
      case 'Cancelled':
        return <Badge className="font-normal text-sm bg-red-500 text-white">Cancelled</Badge>
      default:
        return <Badge className="font-normal text-sm bg-gray-500 text-white">Unknown</Badge>
    }
  }
